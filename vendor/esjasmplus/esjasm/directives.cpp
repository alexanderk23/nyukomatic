...
void InsertDirectives() {
	...
	DirectivesTable.insertd(".fpos",dirNOOP);
	...
	DirectivesTable.insertd(".include", dirNOOP);
	DirectivesTable.insertd(".incbin", dirNOOP);
	DirectivesTable.insertd(".binary", dirNOOP);
	DirectivesTable.insertd(".inchob", dirNOOP);
	DirectivesTable.insertd(".inctrd", dirNOOP);
	DirectivesTable.insertd(".insert", dirNOOP);
	DirectivesTable.insertd(".savenex", dirNOOP);
	DirectivesTable.insertd(".savesna", dirNOOP);
	DirectivesTable.insertd(".savehob", dirNOOP);
	DirectivesTable.insertd(".savebin", dirNOOP);
	DirectivesTable.insertd(".savedev", dirNOOP);
	DirectivesTable.insertd(".emptytap", dirNOOP);
	DirectivesTable.insertd(".savetap", dirNOOP);
	DirectivesTable.insertd(".emptytrd", dirNOOP);
	DirectivesTable.insertd(".savetrd", dirNOOP);
	DirectivesTable.insertd(".savecpcsna", dirNOOP);
	DirectivesTable.insertd(".savecdt", dirNOOP);
	DirectivesTable.insertd(".save3dos", dirNOOP);
	DirectivesTable.insertd(".saveamsdos", dirNOOP);
	DirectivesTable.insertd(".savecpr", dirNOOP);
	DirectivesTable.insertd(".shellexec", dirNOOP);
	...
	DirectivesTable.insertd(".output", dirNOOP);
	DirectivesTable.insertd(".outend", dirNOOP);
	DirectivesTable.insertd(".tapout", dirNOOP);
	DirectivesTable.insertd(".tapend", dirNOOP);
	...
	DirectivesTable.insertd(".labelslist", dirNOOP);
	DirectivesTable.insertd(".cspectmap", dirNOOP);
	...
	DirectivesTable.insertd(".bplist", dirNOOP);
	DirectivesTable.insertd(".setbreakpoint", dirNOOP);
	DirectivesTable.insertd(".setbp", dirNOOP);
	...
	DirectivesTable.insertd(".sldopt", dirNOOP);
