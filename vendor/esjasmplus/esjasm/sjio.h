...
#include <string>
extern std::string *sj_input;
extern std::string *sj_output;
extern std::string *sj_errors;
...
void OpenFile(void *nfilename = nullptr, void *fStdinLog = nullptr);
...
int SaveRAM(std::string &, int, int);
